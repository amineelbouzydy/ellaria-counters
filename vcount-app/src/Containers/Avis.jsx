...
export default function Avis() {
    return (
        <>
            <div className="mt-40">
                <h1 className="lg:text-5xl md:text-4xl text-2xl font-semibold px-4 leading-10 text-gray-800 mt-6 text-center">Avis de nos clients</h1>
                    ...
                    <div>
                        <div className="group w-full bg-white relative flex flex-col items-center hover:bg-indigo-700 cursor-pointer shadow-md md:p-12 p-6">
                            <div className="text-gray-600 group-hover:text-white flex flex-col items-center">
                                ...
                                Ellaria Systems a dépassé mes attentes. Votre équipe a été passionnante et vos idées ont fait grandir mon entreprise. Merci pour votre professionnalisme et votre intérêt sincère.</p>
                            </div>
